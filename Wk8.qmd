...
![Land Use and Cover Change, Source:](img08/LUCC.png){#fig-LUCCresults} \* Urban Heat Island pattern
...
![UHI prediction](img08/UHIpred.png){#fig-UHIpredict}
...
![UHI in different senarioes](img08/UHIinscenario.png){#fig-UHI-in-scenario}
