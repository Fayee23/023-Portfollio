...
![observations from satellite](img03/observations-from-satellite.png){#fig-SatelliteObservation}
...
![Result in Chesapeake Bay](img03/app-radiance.png){#fig-app3result1}

![Result in Florida Keys](img03/app-result.png){#fig-app3result2}
:::
...
-   Data correction and enhancement are quite practical in real project, because we should know to what extent the data is being manipulated and how it is processed. Also, we may need to join the data sets and merge the imagery to show the research area or planning site.

* On the other hand, correction can be also used in specific research areas, such as detecting ocean color in meteorology and atmospheric sciences, and detect healthy vegetation in agriculture.
