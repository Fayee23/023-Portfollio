...
-   Empirical Line Correction
    ...
    ![radiance reflect, Source: Remote Sensing in Precision Agriculture](img03/Path-radiance.png){#fig-radiance}

    -   Atmospheric attenuation: absorption of EMR due to materials in atmosphere (e.g. water vapour)

    ![Atmospheric attenuation, Source: GIS geography](img03/Atmospheric-attenuation.png){#fig-EMRabsorption}
