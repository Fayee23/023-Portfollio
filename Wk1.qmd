...
Remote sensing can play an important role in policy assessment related to urban growth, population dynamics and environmental issues within cities.
...
### Urban social vulnerability assessment.
...
there are still important differences of opinion on the indicators of and contributors to quality of life and on how to use the information that indicators provide [@li2007a]

As with the relationships between land-cover and socioeconomic variables, local research and knowledge must be considered for the results to be useful in policy making, urban planning and management.